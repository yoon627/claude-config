...
# Progress
- 2026-09-03: Red 는 격리 runner 실측(exit 127, `mapfile: command not found`). 2줄 교체 → 같은 bash 에서 exit 0, shellcheck 통과. code-reviewer APPROVE(Codex 크레딧 소진). `/e merge` PR #152.
