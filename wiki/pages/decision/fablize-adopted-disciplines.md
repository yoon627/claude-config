...
sources:
  ...
  - plans/2026-09-24-prompt-audit-apply/prompt-audit-apply-plan.md
---
...
- out-of-spec 결함 발견 · 개방형 창의 · **self-driven 개선 깊이**. harness 로 못 옮기는 모델 능력. → 자기개선은 [[self-diagnosis-and-improvement-status]] 대로 수집·분석 기계화(2026-07-03, dlc-signal+/improve)까지 — 반영(수정)은 여전히 사용자 승인 후, 자동 수정은 안 함.
